...
endc
	...
	move THUNDER,         EFFECT_THUNDER,           110, ELECTRIC,   85, 20,  45, SPECIAL
...
endc
	...
	move DRAINING_KISS,   EFFECT_LEECH_HIT,          95, FAIRY,     100, 15,   0, SPECIAL
...
endc
	...
	move DYNAMICPUNCH,    EFFECT_CONFUSE_HIT,       90, FIGHTING,   80,  15, 70, PHYSICAL
...
endc
	...
	move CRUNCH,          EFFECT_FLINCH_HIT,   75, DARK,      80, 15,  20, PHYSICAL
