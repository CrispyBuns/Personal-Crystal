...
; CARBOS
	item_attribute 100, 0, MON_SPE_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CALCIUM
	item_attribute 250, 0, MON_SAT_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ZINC
