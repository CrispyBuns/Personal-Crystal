...
; GREAT BALL
	item_attribute 310, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; ULTRA BALL
	item_attribute 450, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; MASTER BALL
...
; MAX REVIVE
	item_attribute 150, 0, 0, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; ETHER
...
; MAX ELIXIR
	item_attribute 45, 0, -1, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; HP UP
	item_attribute 1000, 0, MON_HP_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PROTEIN
	item_attribute 1500, 0, MON_ATK_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; IRON
	item_attribute 1500, 0, MON_DEF_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CARBOS
	item_attribute 1500, 0, MON_SPE_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CALCIUM
	item_attribute 150, 0, MON_SAT_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ZINC
	item_attribute 1500, 0, MON_SDF_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; RARE CANDY
	item_attribute 10000, 0, 0, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PP UP
	item_attribute 1000, 0, 0, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PP MAX
	item_attribute 10000, 0, 0, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; FRESH WATER
...
; WATER STONE
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; THUNDERSTONE
	item_attribute 300, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ICE STONE
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; MOON STONE
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; SUN STONE
	item_attribute 250, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; DUSK STONE
	item_attribute 250, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; SHINY STONE
	item_attribute 150, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; EVERSTONE
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EXP.SHARE
	item_attribute 150, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILK SCARF
...
; METAL COAT
	item_attribute 10, HELD_TYPE_BOOST, STEEL, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
...
; MAGNET
	item_attribute 250, HELD_TYPE_BOOST, ELECTRIC, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TWISTEDSPOON
...
; QUICK CLAW
	item_attribute 1000, HELD_QUICK_CLAW, 20, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KING'S ROCK
	item_attribute 50, HELD_FLINCH_UP, 10, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AMULET COIN
...
; LUCKY EGG
	item_attribute 20, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEFTOVERS
	item_attribute 1000, HELD_LEFTOVERS, 10, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOOTHE BELL
...
; WISE GLASSES
	item_attribute 150, HELD_CATEGORY_BOOST, SPECIAL, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EXPERT BELT
...
; LIFE ORB
	item_attribute 150, HELD_LIFE_ORB, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS SASH
...
; SCOPE LENS
	item_attribute 450, HELD_CRITICAL_UP, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WIDE LENS
...
; CHOICE BAND
	item_attribute 50, HELD_CHOICE, ATTACK, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE SCARF
